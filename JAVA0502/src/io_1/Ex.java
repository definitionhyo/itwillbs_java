...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => 출력 노드 : 모니터, 스피커, 파일, 네트워킁, 데이터베이스 등
		 *   
		 * - Stream(스트림) : 입력 또는 출력 데이터가 한 방향으로 끊임없이 전송되는 것
		 *   => 출발지 노드 -> 도착지 노드
		 * - 자바는 다양한 입출력 장치와 무관하고 일관성 있게 프로그램을 구현할 수 있또록
		 *   일종의 가상 통로인 스트림을 제공
		 *   
		 * [ 입력 스트림과 출력 스트림 ]
		 ...
		 * 
		 * - 스트림은 단방향 통신만 가능하게 때문에 입력과 출력을 동시에 수행하려면
...
//			                   // IOExcpetion이 발생할 수 있으니 예외 처리 필수!
...
//		}
		 ...
		 *   try ~ catch 블록 작업이 끝나면 자동으로 자원을 반한해 주도록 함.
		 *   
		 * < 기본 문법 >
