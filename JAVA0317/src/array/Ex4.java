...
//		System.out.println(arr[2][1]);
		...
		System.out.println("배열 arr 의 0번 행의 크기 : " + arr[0].length);
		System.out.println("배열 arr 의 1번 행의 크기 : " + arr[1].length);
		System.out.println("배열 arr 의 2번 행의 크기 : " + arr[2].length);
		System.out.println("--------------------------");
...
//		int[][] arr2 = new int[3][]; // 3행의 공간이 먼저 생성됨
		
		// 각 행에 접근하여 열을 생성하는 코드를 작성
		// 배열명[행번호] = new int[열크기];
//		arr2[0] = new int[3]; // 정수형 배열 3개를 생성 후 0번 행에 주소 저장
//		arr2[1] = new int[2]; // 정수형 배열 2개를 생성 후 1번 행에 주소 저장
//		arr2[2] = new int[4]; // 정수형 배열 4개를 생성 후 2번 행에 주소 저장
//		
//		arr2[0][0] = 1; arr2[0][1] = 2; arr2[0][2] = 3;
//		arr2[1][0] = 1; arr2[1][1] = 2; 
//		arr2[2][0] = 1; arr2[2][1] = 2; arr2[2][2] = 3; arr2[2][3] = 4;
		// ---------------------------------------------
