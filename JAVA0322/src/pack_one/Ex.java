...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   => 클래스명이 중복되지 않도록 하려면 도메인 네임을 사용
		 *      (단, 도메인 네미을 최상위도메인부터 역순으로 지정)
		 *      
		 * package 키워드
		 ...
		 *   해당 패키지와 클래스명을 지정할 경우 패지키명을 생략 가능함
		 *   (단, 같은 패키지 내의 클래스는 패키지명을 생략 가능!) 
		 * - java.lang 패키지는 유일하게 import 문 없이도 샹략 가능한 패키지
		 *   => 그 외의 모든 패키지는 반드시 위치 정보가 필요함
		 * - import 문은 패키지명보다 아래쪽, 클래스 선언부보다 위쪽에 위치하며
...
//		Random r; // 컴파일 에러 발생!
		...
		// java.util 패키지의 Random 클래는 생략 불가능한 패키지명이므로
...
//		java.util.Random r;
		...
		// => 단, 실제 작성 시 명확한 구분을 위해
		//    둘 다 패키지명을 명시하는게 좋다!
		ExPack ex2 = new ExPack(); // pack_two 패키지의 ExPack 클래스
		pack_three.ExPack ex3; // pack_three 패키지의 ExPack 클래스
