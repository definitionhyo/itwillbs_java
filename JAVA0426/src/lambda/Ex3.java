...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		// 정적 메서드 useFIMethodA 의 파라미터가 MyFunc1 의 인터페이스 타입이므로
