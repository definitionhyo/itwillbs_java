...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 * } else if(조건식n) {
		 * 		// 조건식1 ~ n-1 의 결과가 false 이고, 조건식n 의 결과가 true 일 때
		 * } else {
...
//			System.out.println(num + " : 0!");
//		}
		// => 주의! 0은 2로 나눈 나머지가 0이므로 짝수 판별 식에서 true 됨
		//    따라서, 0을 출력하는 문장은 실행될 수 없다!
		// => 해결책 : 최소한 0을 판별하는 문장(0과 같다)이 짝수 판별 문장보다
		//             윗쪽에 위치해야 한다! (홀수 판별식의 위치는 무관함)
		num = 0;
		...
		if(num % 2 == 1) { // 홀수일 경우
			...
			// 최소한 0을 판별하는 조건식보다 아래쪽에서 짝수를 판별해야한다!
			System.out.println(num + " : 짝수!");
		}
		...
		// else if 문 작성 시 조건식의 범위가 좁은 조건식부터 판별해야함!
		if(num > 10) {
			System.out.println("10보다 크다!");
		} else if(num > 5) {
			System.out.println("5보다 크다!");
