...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *   static 메서드인 getInstace() 메서드로 리턴받아 사용
...
//		System.out.println(cal); // toString() 메서드 생략
...
//		System.out.println(cal2);
		cal2.set(1999, 11, 30); // 연, 월, 일 직접 전달
		...
		cal2.set(Calendar.YEAR, 2023); // 2023년으로 설정
		cal2.set(Calendar.MONTH, 4 - 1); // 4월로 설정(-1 필요)
