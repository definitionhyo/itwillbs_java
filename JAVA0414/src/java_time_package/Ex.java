...
public class Ex {
	...
	public static void main(String[] args) {
		...
		//    같으면 0 리턴함
		// => 연, 월, 일을 모두 비교하는 것이 아니라 연도다를 경우에는 연도를
		//    연도가 같다면 월을, 연도와 월이 같다면 일을 비교
		System.out.println(date3.compareTo(date4));
		
		// 2. isAfter()
		System.out.println("현재 날짜보다 더 미래인가? : " + date3.isAfter(date4));
		
		// 3. isBefore()
		System.out.println("현재 날짜보다 더 과거인가? : " + date3.isBefore(date4));
