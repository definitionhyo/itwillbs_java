...
public class Test {
	...
	public static void main(String[] args) {
		...
		/*
		 * 2. 문자열에 포함된 내용(주소) 중에서 실제 주소 부분만 추출하여 출력
		 * - 입력 형식 : "Address:주소..."
		 *   ex) "Address:부산광역시 부산진구 동천로 109" 
		 * - 출력 형식 : "Address:" 부분을 제외하고 나머지 주소만 추출하여 출력
		 *   ex) "부산광역시 부산진구 동천로 109" 출력
		 */
		String address = "Address:부산광역시 부산진구 동천로 109";
