...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 문자열 내욜 비교 시 동등비교(==) 연산보다 equals() 메서드 사용
		...
		System.out.println(
				"s1.equals(JAVA PROGRAMMING) : " + s1.equals("JAVA PROGMRAMMING"));
		...
		// => 문자열은 char[] 배열로 관리되며 5번 인덱스 해당하는 'P' 가 출력됨
...
//		System.out.println("s1.concat(!) : " + s1 + "!");
		...
		// => 앞에서부터 문자열 "Pragram" 을 탐색하여 시작인덱스 5 리턴
...
//		String[] strArr = s4.split("."); // 모든 문자열이 제거되므로 사용 불가
		...
		// 정규표현식에 따라 . 기호를 구분자로 지정해야할 경우 \\. 사용
