...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * 1. 기본 데이터타입(8가지)
		 * --------------------------------------------------------------
		 * 			1Byte(8bit)  2Byte(16bit)  4Byte(32bit)  8Btye(64bit)
		 * --------------------------------------------------------------
		 * 논리형	boolean
...
//		b = 100;
		...
		b = 127;
//		b = 128; // 오류 발생! byte 타입에 저장 가능한 정수 -128 ~ 127 까지
		b = -128;
		...
		s = 32767;
//		s = 32768; // 오류 발생! short 타입 저장 가능한 정수 -32768 ~ 32767
...
//		i = 2147483648L; // 오류 발생! long 타입 정수는 int 타입 변수에 저장 X
		...
		// int 타입보다 크지 않는 정수도 접미사 L 을 붙이면 long 타입으로 취급됨
//		i = 5L; // 오류 발생! 정수 5는 int 범위에 포함되지만, L 붙이면 저장 불가!
		
		// 실수 데이터타입
		double d = 3.14; // 실수 기본 데이터타입 double
//		float f = 3.14; // 오류 발생!
		// 접미사가 없으면 double 타입으로 인식되므로 float 타입 변수에 저장 불가!
		float f = 3.14f;
...
//		num = 0xG; // 오류 발생! 16진수 알파벳 A ~ F 까지만 사용
