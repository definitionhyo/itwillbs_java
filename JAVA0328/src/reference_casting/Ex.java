...
//		p.parentPrn();
		...
		// Parent 타입 레퍼런스 변수 p 로 접근 가능한 메서드 
...
//		p.childPrn(); // 서브클래스에서 정의한 메서드(접근 불가) => 오류 발생!
		...
		/*
		 * 다운캐스팅(Down Casting)
		 * - 서브클래스의 레퍼런스 변수(참조변수)가 슈퍼클래스의 인스턴스를 참조하는 것
...
//		c2 = (Child)p2; // Parent -> Child 타입으로 강제 형변환 = 다운캐스팅
		...
		// java.lang.ClassCastException: Prarent cannot be cast to Child
