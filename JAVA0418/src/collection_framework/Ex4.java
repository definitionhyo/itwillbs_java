...
//		map.put(3, "Spring framework");
		...
		// Collection vlaues() : Map 객체 내의 모든 값 리턴
//		List vlaueList = (List) map.values(); // 주의! 직접 다운캐스팅 불가!
		List vlaueList = new ArrayList(map.values()); // 객체 생성 파라미터로 전달
		System.out.println("모든 값 : " + vlaueList);
		...
		System.out.println(
				"이순신이라는 이름이 존재합니까? " + map2.containsValue("이순신"));
		
		// containsKey() : 특정 키를 탐색
		System.out.println(
				"010-1234-5678 전화번호 존재? : " + map2.containsKey("010-1234-5678"));
