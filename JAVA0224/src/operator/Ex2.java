...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// b1 과 b2의 연산 결과를 byte 타입 변수 b3 에 저장할 때 문제 발생!
...
//		int i2 = i + l; // (long)int + long = long 이므로 int 타입 변수에 저장 불가
		int i2 = (int)(i + l); // int 타입으로 강제형변환
		System.out.println(i2);
		
		float f = 3.14f;
		long l2 = (long)(l + f); // long + float = float 이므로 long타입으로 변환
...
//		System.out.println(d1);
		...
		//    두 실수 모두 정수로 변환하여 연산 수행 후 다시 실수 변환
		...
		// 단, 리터럴끼리의 연산도 표현 가능 범위를 초과하면 오류 발생!
