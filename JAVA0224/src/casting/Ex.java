...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   메모리 크기가 long 이 float 보다 더 크더라도 float 타입이 큼
		 *        
		 * 2. 강제 형변환(= 명시적 형변환)
...
//		b2 = b1; // 오류 발생!
		...
		// => 개발자가 강제로 형변환 연산자를 사용하여 명시적 형변환 수행해야함
...
//		short c2 = c1; // 오류 발생! 강제 형변환 필수!
		...
		// => double 타입이 int 타입보다 크므로 컴파일러에 의해서 자동으로 형변환됨
