...
public class Ex4 {
	...
	public static void main(String[] args) {
		...
		System.out.println(
				"정수 10을 2진수로 변환 : " + Integer.toBinaryString(num1));
		
		System.out.println(
				"정수 10을 8진수로 변환 : " + Integer.toOctalString(num1));
		
		System.out.println(
				"정수 10을 16진수로 변환 : " + Integer.toHexString(num1));
		...
		// => 대문자 : 문자 ch 가 'A'(65) 이상이고, 문자 ch 가 'Z'(90) 이하
		if(ch >= 'A' && ch <= 'Z') {
