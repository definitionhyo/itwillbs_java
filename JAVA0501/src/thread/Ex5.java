...
public class Ex5 {
	...
	public static void main(String[] args) {
		...
		System.out.println("t1 쓰레드 우선순위 : " + t1.getPriority()); // 5
		System.out.println("t2 쓰레드 우선순위 : " + t2.getPriority()); // 5
		
		t1.setPriority(Thread.MIN_PRIORITY); // 우선순위 1로 변경
		t2.setPriority(Thread.MAX_PRIORITY); // 우선순위 10으로 변경
		
		System.out.println("t1 쓰레드 우선순위 변경 후 : " + t1.getPriority()); // 1
		System.out.println("t2 쓰레드 우선순위 변경 후 : " + t2.getPriority()); // 10
