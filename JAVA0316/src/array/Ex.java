...
public class Ex {
	...
	public static void main(String[] args) {
		/*
		 * 배열(Array)
		 * - 같은 타입 데이터 여러개를 하나의 묶음(변수)으로 다루는 
		 *   메모리 공간
		 *   
		 * [ 특징 ]
		 * 1. 같은 타입 데이터만 저장 가능
		 ...
		 * 6. 배열이 생성될 경우 배열의 데이터 저장 공간은 배열의 데이터타입에
		 *    해당하는 기본값으로 자동으로 초기화
		 ...
		 * => 배열 공간이 생성되기 전이므로, 아직 데이터 자정은 불가
		 ...
		 * => 이제, 실제 메모리 공간이 생성되었으므로 데이터 저장 가능
...
//		} 
		...
		// 배열 전체 접근 시 기본 공식을 사용하여 배열 데이터를 모두 출력
