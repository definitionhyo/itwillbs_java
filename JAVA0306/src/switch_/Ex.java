...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 * - 일치하는 case 문이 없을 경우 default 문을 찾아서 실해함
		 *   => if문의 else 문과 유사하며, 생략도 가능함
		...
		switch(num) {
			...
			default : 
				...
				// default 문 아래쪽에 다른 실행문이 없으므로 break 문을 생략 가능!
		}
