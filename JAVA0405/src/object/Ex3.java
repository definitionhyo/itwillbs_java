...
public class Ex3 {
	...
	public static void main(String[] args) {
		 ...
		 *   객체가 가지는 멤버변수값을 문자열로 결합하여 리턴하도록 해야함
		...
		Person2 p2 = new Person2("홍길동", 20, "041010-3123456");
		System.out.println("사람 p2 의 정보 : " + p2); // p2.toString() 과 결과 동일
		System.out.println("사람 p2 의 정보 : " + p2.toString()); // Person2@53bd815b
