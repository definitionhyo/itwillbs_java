...
public class Ex2 {
	...
	public static void main(String[] args) {
		...
		// static 메서드도 static 멤버변수처럼 인스턴스 생성과는 무관하므로
		// 인스턴스 생성 없이도 클래스명만으로 접근 가능
		StaticMethod.staticMethod();
		
//		StaticMethod.setStaticVar = 99; // private 접근제한자 적용 시 접근 불가
		// => Setter 를 호출하여 접근 가능
...
class StaticMethod {
	...
	// staitc 메서드 staticMethod() 메서드 정의 - 파라미터, 리턴값 없음
...
//		this.staticVar = staticVar;
		...
		//    static 메서드가 로딩되는 시점에서는 레퍼런스 this 가 존재하지 않음!
