...
public class Ex {
	...
	public static void main(String[] args) {
		...
		fm.change();
		System.out.println("finalMember = " + fm.getFinalMember());
...
class FinalMember {
	...
	public FinalMember(int blankFinalMember) {
		super();
		this.blankFinalMember = blankFinalMember; // blankFinalMember 초기화
	}
...
// ----------------------------------------------------------------
// final 클래스의 대표적인 예 : java.lang.String, java.lang.Meth 등
//class SubString extends String {} // String 클래스 상속 불가
//class SubMeth extends Meth {} // Math 클래스 상속 불가
