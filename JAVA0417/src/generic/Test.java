...
//		}
		...
		// 문자열 "이재승" 추가
//		list.add("이재승"); // Object 타입이므로 Person 이 아닌 타입도 추가 가능
...
//			// => "이재승" 의 String 형태는 Person 객체로 변경할 수 없음을 알 수 있다.
//			// => 위의 코드 중 "list.add("이재승"); 을 주석처리하고 다시 실행하면
//			//    오류가 없어진다!
//			
