...
public class Ex {
	...
	public static void main(String[] args) {
		 ...
		 *   ex) '밥먹다' 기능을 메서드로 표현(밥을 떠서 입에 넣고 씹기 등)
		 * - 메서드는 반드시 호출되어야만 실행될 수 있음
		 * - 메서드 호출 시 메서드에 전달하는 값을 전달인자(Argument)라고 하며,
		 *   이 전달 인자를 전달받아 저장하는 변수를 매개변수(Prameter)라고 함.
		 ...
		 *      반드시 어떤 경우에도 return 문이 실행되도록 조건식을 작성해햐함.
		 *      
		...
		// 주의! 리턴값이 없는 메서드를 출려문에서 호출하거나 변수에 대입 불가!
