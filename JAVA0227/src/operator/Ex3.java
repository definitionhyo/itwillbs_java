...
public class Ex3 {
	...
	public static void main(String[] args) {
		...
		// 주민번호 표현 시
//		int jumin = 041010-3234567; // 결과값 잘못됨 = 뺄셈으로 취급됨
//		int jumin = 0410103234567; // 오류 발생! = int 타입으로 표현 불가능함
//		long jumin = 0410103234567L; // long 타입으로 표현하거나
		String jumin = "041010-3234567";
